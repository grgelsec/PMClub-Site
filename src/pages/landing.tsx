      ...
      {/* <header id="hero" className="w-full py-2 px-4 md:px-6 lg:px-1">
        <div className="max-w-8xl mx-auto px-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-0">
            ...
            <div className="flex flex-row justify-center space-x-4 w-full sm:w-auto"></div>
          </div>
        </div>
      </header> */}

      <div
        className="flex min-h-screen items-start justify-center flex-col p-4 sm:p-6 md:p-8"
        id="hero"
      >
        <div className="flex items-center justify-center w-full h-full min-h-[calc(100vh-4rem)] shadow-xl rounded-xl p-2 sm:p-4 bg-[#cca7ff]">
          <div className="container mx-auto rounded-xl py-6 sm:py-8 md:py-10 px-4">
            <div className="flex justify-center items-center flex-col space-y-5">
              ...
              <div className="bg-white shadow-xl p-3 sm:p-4 md:p-6 rounded-xl transition-transform hover:scale-105 duration-300 w-full max-w-3xl mx-4">
                <h1 className="font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-center bg-[#D5B8FF] via-[#98FFD6] to-[#FFD6A5] bg-clip-text text-transparent animate-gradient relative transition-transform hover:scale-103 duration-300">
