...
export const InterestPage = () => {
  return (
    <div id="board" className="min-h-screen w-full p-8 lg:p-24 mb-16">
      <div className="flex w-full justify-center duration-300">
      ...
      <div className="w-full min-h-screen p-2 sm:p-4 bg-gradient-to-br from-[#D5B8FF] via-[#98FFD6] to-[#FFD6A5] rounded-xl">
        <main className="min-h-screen w-full p-4 sm:p-6 md:p-8 lg:p-24 bg-white rounded-xl">
          <div className="flex flex-col items-center max-w-7xl mx-auto">
            <h1 className="font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-center bg-gradient-to-r from-[#D5B8FF] via-[#98FFD6] to-[#FFD6A5] bg-clip-text text-transparent animate-gradient transition-transform shadow-xl p-4 rounded-xl">
              BOARD
            </h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 w-full mt-8">
              {[
                ...
                <div
                  key={index}
                  className="bg-gradient-to-br from-[#D5B8FF] via-[#98FFD6] to-[#FFD6A5] p-[2px] rounded-xl"
                >
            ...
            <h1 className="font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-center bg-gradient-to-r from-[#D5B8FF] via-[#98FFD6] to-[#FFD6A5] bg-clip-text text-transparent animate-gradient mt-12 shadow-xl p-4 rounded-xl">
              COMMITTEE
            </h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 w-full mt-8">
              {[
                ...
                <div
                  key={index}
                  className="bg-gradient-to-br from-[#FFD6A5] via-[#98FFD6] to-[#D5B8FF] p-[2px] rounded-xl"
                >
                  <div className="bg-white p-6 sm:p-8 md:p-12 rounded-xl h-full flex flex-col justify-center items-center">
                    <div className="font-bold text-lg md:text-xl text-center text-black">
                      {position.name}
